/*=========================================================================
  ...
  Module:    $RCSfile: itkLabelDiffeomorphicDemonsRegistrationFilter.txx,v $
  Language:  C++
...
#ifndef LabelDiffeomorphicDemonsRegistrationFilter_txx
#define LabelDiffeomorphicDemonsRegistrationFilter_txx
...
LabelDiffeomorphicDemonsRegistrationFilter<TFixedImage,TMovingImage,TDeformationField>
::LabelDiffeomorphicDemonsRegistrationFilter()
   :m_UseFirstOrderExp(false)
{
 
  typename LabelDemonsRegistrationFunctionType::Pointer drfp;
  drfp = LabelDemonsRegistrationFunctionType::New();
 ...
 */
template <class TFixedImage, class TMovingImage, class TDeformationField>
const typename LabelDiffeomorphicDemonsRegistrationFilter<TFixedImage,TMovingImage,TDeformationField>
::LabelImageType *
LabelDiffeomorphicDemonsRegistrationFilter<TFixedImage,TMovingImage,TDeformationField>
...
/*
 * Set the  Moving Grad image image.
 */
template <class TFixedImage, class TMovingImage, class TDeformationField>
void
LabelDiffeomorphicDemonsRegistrationFilter<TFixedImage,TMovingImage,TDeformationField>
...
/*
 * Get the  Moving Grad image image.
 */
template <class TFixedImage, class TMovingImage, class TDeformationField>
const typename LabelDiffeomorphicDemonsRegistrationFilter<TFixedImage,TMovingImage,TDeformationField>
::GradImageType *
 ...
 */
template <class TFixedImage, class TMovingImage, class TDeformationField>
typename LabelDiffeomorphicDemonsRegistrationFilter<TFixedImage,TMovingImage,TDeformationField>::LabelDemonsRegistrationFunctionType *
LabelDiffeomorphicDemonsRegistrationFilter<TFixedImage,TMovingImage,TDeformationField>
::DownCastDifferenceFunctionType()
{
  LabelDemonsRegistrationFunctionType *drfp = 
    dynamic_cast<LabelDemonsRegistrationFunctionType *>
 ...
 */
template <class TFixedImage, class TMovingImage, class TDeformationField>
const typename LabelDiffeomorphicDemonsRegistrationFilter<TFixedImage,TMovingImage,TDeformationField>::LabelDemonsRegistrationFunctionType *
LabelDiffeomorphicDemonsRegistrationFilter<TFixedImage,TMovingImage,TDeformationField>
::DownCastDifferenceFunctionType() const
{
  const LabelDemonsRegistrationFunctionType *drfp = 
    dynamic_cast<const LabelDemonsRegistrationFunctionType *>
      (this->GetDifferenceFunction().GetPointer());
...
::InitializeIteration()
{
  ...
  LabelDemonsRegistrationFunctionType *f = this->DownCastDifferenceFunctionType();
  f->SetDeformationField( this->GetDeformationField() );
  //LabelImageConstPointer LabelPtr = this->GetLabelImage();

  //if( !LabelPtr )
  //  {
  //  itkExceptionMacro( << "LabelPtr image not set" );
  //  }

  // update variables in the equation object

  //f->SetLabelImage( LabelPtr );

 // f->SetMovingGradImage(MovingGradPtr);

  HistogramFieldPointer movingHistogramPtr=this->GetMovingHistogramField();
  if(!movingHistogramPtr)
  {
    itkExceptionMacro( << "moving histogram not set" );
  }
  f->SetMovingHistogramField(movingHistogramPtr);

  HistogramFieldPointer fixedHistogramPtr=this->GetFixedHistogramField();
  if(!fixedHistogramPtr)
  {
    itkExceptionMacro( << "fixed histogram not set" );
  }
  f->SetFixedHistogramField(fixedHistogramPtr);
...
::GetMetric() const
{
  const LabelDemonsRegistrationFunctionType *drfp = this->DownCastDifferenceFunctionType();
...
{
  LabelDemonsRegistrationFunctionType *drfp = this->DownCastDifferenceFunctionType();
 ...
 *   
 */
template <class TFixedImage, class TMovingImage, class TDeformationField> GradientType
LabelDiffeomorphicDemonsRegistrationFilter<TFixedImage,TMovingImage,TDeformationField>
